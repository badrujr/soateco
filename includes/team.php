				...
				<div class="row">
					<div class="col-12 wow zoomIn">
						<div class="section-title">
							<h2>SOATECO Top <span>Leaders</span></h2>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.4s">
						...
						<div class="single-team">
							...
							<div class="team-hover">
								<h4>Boniphace Michael Sumbuka<span>President</span></h4>
					...
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.6s">
						...
						<div class="single-team">
							...
							<div class="team-hover">
								<h4 class="name">Ian Harvey<span class="work">Vice President</span></h4>
								<p>cumque nihil impedit quo minusid quod maxime placeat facere possimus</p>
								<ul class="social">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.8s">
						...
						<div class="single-team">
							...
							<div class="team-hover">
								<h4 class="name">Gerald Peter Mseti<span class="work">Prime Minister</span></h4>
								<p>cumque nihil impedit quo minusid quod maxime placeat facere possimus</p>
								<ul class="social">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
